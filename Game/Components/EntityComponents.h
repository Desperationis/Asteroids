...
namespace MASK_ENTITY {
	...
	const EntityMask COMPONENT_INVINCIBLE = 1 << 14;
	const EntityMask COMPONENT_AI = 1 << 15;
	const EntityMask COMPONENT_ENEMYBULLET = 1 << 16;

	const EntityMask POWERUP_RAPIDFIRE = 1 << 17;
	const EntityMask POWERUP_GRAPESHOT = 1 << 18;
	const EntityMask POWERUP_INFINITYBULLET = 1 << 19;
	const EntityMask POWERUP_DMG = 1 << 20;
	...
	const EntityMask COMPONENT_UFO = COMPONENT_DUMMY | COMPONENT_HITBOX | COMPONENT_HEALTH | COMPONENT_AI | COMPONENT_WALLLOOP;
	const EntityMask COMPONENT_POWERUP = COMPONENT_DUMMY | COMPONENT_HITBOX | COMPONENT_DRIFT | COMPONENT_WALLLOOP;
}
